...
def plan(publisher_sha: str):
    ...
    for name, environment, ref, workflow in (
        ("candidate-v30", "iq9075-candidate-sign", f"refs/tags/{tag}", "iq9075-candidate-trusted-publish.yml"),
        ("release-main-v30", "iq9075-release", "refs/heads/main", "release-publish.yml"),
    ):
