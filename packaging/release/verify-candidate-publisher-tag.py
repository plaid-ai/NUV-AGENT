...
EXPECTED_TAG = "candidate-publisher-v37"
...
def _candidate_policy(policy_path: Path) -> tuple[dict[str, Any], set[str]]:
    ...
    if (
        ...
        or candidate.get("retiredTagRefs") != [
            "refs/tags/candidate-publisher-v1", "refs/tags/candidate-publisher-v2",
            "refs/tags/candidate-publisher-v3", "refs/tags/candidate-publisher-v4", "refs/tags/candidate-publisher-v5",
            ...
            "refs/tags/candidate-publisher-v33", "refs/tags/candidate-publisher-v34", "refs/tags/candidate-publisher-v35", "refs/tags/candidate-publisher-v36",
        ]
