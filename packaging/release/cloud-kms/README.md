...
This change does **not** mark `0.1.122` READY or resume an IQ9075 OTA test.
`candidate-publisher-v27` signs sequence 24 with the development OTA KMS key.
...
to the exact approved workflow commit. Provision v27 only after merging and
