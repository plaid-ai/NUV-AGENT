...
This change does **not** mark `0.1.123` READY or resume an IQ9075 OTA test.
`candidate-publisher-v28` signs sequence 25 with the development OTA KMS key.
...
to the exact approved workflow commit. Provision v28 only after merging and
