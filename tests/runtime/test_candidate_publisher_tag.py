...
class CandidatePublisherTagTest(unittest.TestCase):
    ...
    def test_accepts_active_tag_signed_with_new_key_frozen_in_publisher(self) -> None:
        ...
        self.assertEqual(result["candidate_publisher_tag"], "candidate-publisher-v28")
        self.assertEqual(
            result["candidate_publisher_tag_ref"], "refs/tags/candidate-publisher-v28"
        )
    ...
    def test_rejects_policy_drift(self) -> None:
        ...
        for field, value in (
            ...
            ("retiredTagRefs", ["refs/tags/candidate-publisher-v28"]),
            (
                "retiredTagRefs",
