...
class PhysicalRollbackBaselineTest(unittest.TestCase):
    def test_current_committed_baseline_is_pinned_separately_from_promotion(self):
        policy = json.loads((ROOT / "packaging/release/release-security-policy.json").read_text())["iq9075"]
        before = copy.deepcopy(policy)
        current = policy["additionalPhysicalRollbackBaselines"][0]
        self.assertEqual(current["releaseSequence"], 12)
        self.assertEqual(READINESS._physical_rollback_baseline(
            policy, "releases/" + current["bomDigest"][7:]), current)
        legacy = policy["legacyPromotedBaseline"]
        self.assertEqual(legacy["releaseSequence"], 1)
        self.assertEqual(READINESS._physical_rollback_baseline(
            policy, "releases/" + legacy["bomDigest"][7:]), legacy)
        self.assertEqual(policy, before)

    def test_unpinned_or_ambiguous_physical_baselines_are_rejected(self):
        original = json.loads((ROOT / "packaging/release/release-security-policy.json").read_text())["iq9075"]
        current = original["additionalPhysicalRollbackBaselines"][0]
        slot = "releases/" + current["bomDigest"][7:]
        for defect in ("absent", "unlisted", "duplicate", "bool-sequence", "bad-digest", "extra-field", "non-list"):
            with self.subTest(defect=defect):
                policy = copy.deepcopy(original)
                baseline = policy["additionalPhysicalRollbackBaselines"][0]
                requested = slot
                if defect == "absent":
                    policy.pop("additionalPhysicalRollbackBaselines")
                elif defect == "unlisted":
                    requested = "releases/" + "0" * 64
                elif defect == "duplicate":
                    policy["additionalPhysicalRollbackBaselines"].append(copy.deepcopy(baseline))
                elif defect == "bool-sequence":
                    baseline["releaseSequence"] = True
                elif defect == "bad-digest":
                    baseline["bomDigest"] = "sha256:invalid"
                elif defect == "extra-field":
                    baseline["promoted"] = True
                else:
                    policy["additionalPhysicalRollbackBaselines"] = {}
                with self.assertRaises(READINESS.ReadinessError):
                    READINESS._physical_rollback_baseline(policy, requested)
...
class ReleaseSecurityWorkflowTest(unittest.TestCase):
        ...
        fleet_evidence = {
            ...
            "updater": {
                ...
                "update": {
                    ...
                    "commandExpiresAt": "2026-09-03T11:00:00.123456Z",
    ...
    def _config_stream_fixture(
        ...
        from tests.runtime.test_iq9075_config_stream_e2e import _network_condition
        ...
        return {
            ...
            "qualificationContext": {
                "startingHeadSequence": release_update["sequence"],
            ...
            "stream": {
                ...
                "poor": {
                    ...
                    "lastAdjustmentReason": "packet_loss_high",
                    "health": "STREAM_CONTINUOUS",
                    "encoder": "x264enc",
                    "projectionShape": "single",
                    "queue": dict(queue),
                    "networkCondition": _network_condition("ACTIVE", run_id, 4400, "2026-09-03T10:05:"),
                },
                "recoveredGood": {
                    "commandId": "66666666-6666-4666-8666-666666666666",
                    "sequence": 6,
                    ...
                    "projectionShape": "single",
                    "queue": dict(queue),
                    "networkCondition": _network_condition("RELEASED", run_id, 4400, "2026-09-03T10:05:"),
                },
                "disabled": command(
        ...
        *,
        ...
        def command_record(
            ...
            return {
                ...
                "status": status,
                "issuedAt": issued_at,
                "expiresAt": "2026-09-03T11:00:00.123456Z",
                "payloadHash": "7" * 64,
    ...
    def test_config_stream_gate_accepts_audited_terminal_qualification_retry(self) -> None:
        with tempfile.TemporaryDirectory() as raw_root:
            inputs = self._fleet_runtime_fixture(Path(raw_root), component_sha="a" * 40)
            ...
            document = read("config_stream_evidence")
            release_sequence = document["releaseCommand"]["sequence"]
            retry = {
                "commandId": "88888888-8888-4888-8888-888888888888",
                "sequence": release_sequence + 1,
                "type": "STREAM_POLICY",
                "status": "FAILED",
                "issuedAt": "2026-09-03T10:05:00Z",
                "expiresAt": "2026-09-03T10:05:30Z",
            }
            document["qualificationContext"] = {
                "startingHeadSequence": retry["sequence"],
                "resumedAfterTerminalCommands": [retry],
                "activeViewerRequired": True,
                "viewerReloadDuringFault": False,
                "viewerStabilizationSeconds": 45,
            }
            for command in (
                document["config"]["apply"],
                document["config"]["restore"],
                document["stream"]["adaptiveCommand"],
                document["stream"]["initialGood"],
                document["stream"]["poor"],
                document["stream"]["recoveredGood"],
                document["stream"]["disabled"],
            ):
                command["sequence"] += 1

            gate = READINESS._validated_config_stream_gate(
                config_stream_evidence=document,
                fleet_manifest=read("commit_manifest"),
                fleet_manifest_raw=inputs["commit_manifest"].read_bytes(),
                fleet_evidence=read("commit_evidence"),
                fleet_evidence_raw=inputs["commit_evidence"].read_bytes(),
                cleanup_evidence=read("commit_cleanup_evidence"),
                rollback_manifest=read("rollback_manifest"),
                rollback_evidence=read("rollback_evidence"),
                candidate_config_stream_runner=ROOT
                / "packaging/dev/run-iq9075-config-stream-e2e.py",
            )[0]
            self.assertEqual(
                gate["qualificationContext"]["resumedAfterTerminalCommands"],
                [retry],
            )

            document["qualificationContext"]["resumedAfterTerminalCommands"][0][
                "status"
            ] = "IN_PROGRESS"
            with self.assertRaises(READINESS.ReadinessError):
    ...
    def test_fleet_runtime_chain_accepts_later_healthy_observations(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as raw_root:
            ...
            document["stream"]["initialGood"]["lastAdjustmentReason"] = "awaiting_hysteresis:stable"
            document["stream"]["poor"]["lastAdjustmentReason"] = "cooldown:packet_loss_high"
            document["stream"]["recoveredGood"]["lastAdjustmentReason"] = "awaiting_hysteresis:stable"
...
class SequenceAndPromotionTest(unittest.TestCase):
    def test_sequence_skips_only_explicitly_retired_unpublished_candidates(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as raw_root:
            root = Path(raw_root)
            artifact = root / "nuv-agent_0.1.132_iq9075-aarch64.agent-bundle.tar.gz"
            ...
            with (
                ...
                reservation, output = PLAN_OTA.plan_sequence(
                    ...
                    version="0.1.132",
                    component_sha="a" * 40,
                    requested_sequence=34,
                    config_schema="12",
                    min_updater_version="0.2.0",
                    built_at="2026-09-02T00:00:00+00:00",
                )
                self.assertEqual(reservation["releaseSequence"], 34)
                self.assertEqual(output["latest_sequence"], "1")
                self.assertEqual(
                    output["reservation_object"], "releases/reservations/iq9075/34.json"
                )
                for rejected in (*range(1, 34), 35):
                ...
                for retired in ([], [True], [0], [2, 2], [1, 2], "2"):
                    ...
                    with self.subTest(retired=retired), mock.patch.object(
                        ...
                        PLAN_OTA.plan_sequence(
                            ...
                            requested_sequence=21, config_schema="12",
...
def candidate_publisher_tag_response(version: int = 37) -> dict[str, object]:
    ...
    payload = (
        f"object {publisher_sha}\ntype commit\ntag candidate-publisher-v{version}\n"
        "tagger Plaid Platform Admin <platform-admins@plaid.ai.kr> "
        f"1788744306 +0900\n\nNUVION IQ9075 candidate publisher v{version}\n"
    )
    raw_tag = (payload + signature).encode("utf-8")
    tag_object_sha = hashlib.sha1(f"tag {len(raw_tag)}\0".encode() + raw_tag).hexdigest()
    return {
        "sha": tag_object_sha,
        ...
        "tag": f"candidate-publisher-v{version}",
        "message": f"NUVION IQ9075 candidate publisher v{version}\n" + signature,
        "verification": {
            "verified": False,
            "reason": "no_user",
            "signature": signature,
...
class CandidatePublisherTagEnvelopeTest(unittest.TestCase):
    ...
    def test_accepts_signed_api_message_shape_and_object_hash(self) -> None:
        tag_object = candidate_publisher_tag_response()
        self.assertEqual(self._rehashed(tag_object), self.TAG_OBJECT_SHA)
        self.assertEqual(
            tag_object["message"],
            "NUVION IQ9075 candidate publisher v37\n"
            + tag_object["verification"]["signature"],
        )
        self.assertEqual(self._verify(tag_object), self.PUBLISHER_SHA)

    def test_retired_v2_preserves_real_api_hash_but_is_not_active(self) -> None:
        tag_object = candidate_publisher_tag_response(version=2)
        self.assertEqual(tag_object["sha"], "c8d6f2284fa588edf5193a10d28d69c0c3fa43d3")
        with self.assertRaises(SETTINGS.SettingsError):
            self._verify(tag_object, object_sha=tag_object["sha"])
    ...
    def test_rejects_unsigned_or_different_api_message(self) -> None:
        for message in (
            None,
            "NUVION IQ9075 candidate publisher v28\n",
        ...
        for malformed in (None, "", signature.removesuffix("-----END PGP SIGNATURE-----\n")):
            with self.subTest(signature=malformed):
                ...
                if isinstance(malformed, str):
                    tag_object["message"] = "NUVION IQ9075 candidate publisher v37\n" + malformed
    ...
    def test_rejects_wrong_payload_headers_even_with_matching_raw_object_hash(self) -> None:
        cases = (
            ...
            ("tag candidate-publisher-v37", "tag candidate-publisher-v1"),
...
class SettingsPolicyTest(unittest.TestCase):
    ...
    def test_settings_audit_accepts_no_environment_wait_and_rejects_reviewer_rule(
            ...
            "conditions": {
                "ref_name": {
                    "include": [
                        ...
                        "refs/tags/candidate-publisher-v18",
                        "refs/tags/candidate-publisher-v19",
                        "refs/tags/candidate-publisher-v20",
                        "refs/tags/candidate-publisher-v21",
                        "refs/tags/candidate-publisher-v22",
                        "refs/tags/candidate-publisher-v23",
                        "refs/tags/candidate-publisher-v24",
                        "refs/tags/candidate-publisher-v25",
                        "refs/tags/candidate-publisher-v26",
                        "refs/tags/candidate-publisher-v27",
                        "refs/tags/candidate-publisher-v28",
                        "refs/tags/candidate-publisher-v29",
                        "refs/tags/candidate-publisher-v30",
                        "refs/tags/candidate-publisher-v31",
                        "refs/tags/candidate-publisher-v32",
                        "refs/tags/candidate-publisher-v33",
        ...
        responses: dict[str, object] = {
            ...
            "/repos/plaid-ai/NUV-AGENT/git/ref/tags/candidate-publisher-v37": {
                "ref": "refs/tags/candidate-publisher-v37",
        ...
        for name in (
            ...
            expected_deployment_policy = (
                {"id": 1, "name": "candidate-publisher-v37", "type": "tag"}
        ...
        with (
            ...
            mock.patch.object(
                ...
                return_value={
                    "candidate_publisher_tag": "candidate-publisher-v37",
                    "candidate_publisher_tag_ref": "refs/tags/candidate-publisher-v37",
            ...
            for tag_refs in (
                ...
                ["refs/tags/candidate-publisher-v1", "refs/tags/candidate-publisher-v4"],
                ["refs/tags/candidate-publisher-v2", "refs/tags/candidate-publisher-v4"],
                [
                    "refs/tags/candidate-publisher-v1",
                    "refs/tags/candidate-publisher-v2",
                    "refs/tags/candidate-publisher-v3",
